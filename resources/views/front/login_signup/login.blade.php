...
@section('title', 'Sign in, Horseyard')
@section('css-content')  
    ...
    <div class="container">
      <div class="d-flex w-100 flex-sm-wrap flex-sm-col">
        ...
        <div class="col">
          ...
          <form action="{{ url('login') }}" class="user_login_form" method="post">
            @csrf
            <h1>Login</h1>            
            ...
            <div class="form-field">
              <div class="form-group">
                ...
                <div class="d-flex justify-content-end">
                  <a href="{{ url('forgotpassword') }}" class="blueLink midlink">Forgot Password?</a>
                </div>
              </div>
            </div>
