...
@section('title', 'Horseyard | Verify')
@section('css-content')  
    ...
    <div class="container">
      <div class="d-flex w-100 flex-sm-wrap flex-sm-col">
        ...
        <div class="col">
          ...
          <form action="{{ url('verify_account') }}" class="code_verify_form" method="post">
            @csrf
            <h1>Please verify your account</h1>
            <p class="tandc mt-0">We have sent a verification code to your Email address. Please enter the code here to continue.</p>
