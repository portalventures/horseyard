...
<div class="card-type">
  <div class="form-group">
    <div class="row">
      ...
      <div class="col col-md-4">
        <select name="transport_type" id="transport_type" class="form-control" required name="transport_type" id="transport_type">
  ...
  <div class="form-group">
    <div class="row">
      <div class="col col-md-2 pr-0">
        <label for="" class="mb-0 mt-2 float-right text-right">No. of Horses to carry<span class="text-orange">*</span></label>
      </div>
      <div class="col col-md-4">
        <select name="transport_no_of_horse_to_carry" id="transport_no_of_horse_to_carry" class="form-control" required>
  ...
  <div class="form-group">
    <div class="row">
      <div class="col col-md-2 pr-0">
        <label for="" class="mb-0 mt-2 float-right text-right">Ramp location<span class="text-orange">*</span></label>
      </div>
      <div class="col col-md-4">
        <select name="transport_ramp_location" id="transport_ramp_location" class="form-control" required>
