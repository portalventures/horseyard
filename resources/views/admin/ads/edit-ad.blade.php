    ...
    <section>
      ...
      <div class="card mb-0">
        <div class="card-content">
          <form class="admin_update_ad_form">
            @csrf
                    ...
                    <div class="d-flex flex-column">
                      @foreach($all_top_categories as $key => $top_categories)
                        <label for="cat-{{$top_categories->category_name}}" class="custom-radio all_top_categories">
                          <input type="radio" name="listing_category" value="{{$top_categories->id}}" {{ $ad_data->category_id == $top_categories->id ? 'checked' : '' }}  id="cat-{{$top_categories->category_name}}" data-id="{{strtolower($top_categories->category_name)}}">
                          <span></span>
                  ...
                  <div class="card-type">
                    <div class="row">
                      ...
                      <div class="col col-md-4">
                        <div class="d-flex flex-column">
                          <input type="text" class="form-control item_price" placeholder="Enter Price" required name="price" id="price" value="{{$ad_data->price}}" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                  ...
                  <div class="card-type">
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col col-md-4">
                          <select name="state" id="state" class="form-control state_list" required>
                  ...
                  <div class="card-type">
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col col-md-10">
                          <input type="text" placeholder="Title of Ad" class="form-control" name="title" id="title" required value="{{ $ad_data->title }}">
                          <span class="errorMessage"></span>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col col-md-10">
                          <textarea name="description" id="description" cols="30" rows="5" placeholder="Description of Ad" class="form-control" required>{{ $ad_data->description }}</textarea>
                          <span class="errorMessage"></span>
                        </div>
                      </div>
                    </div>
              ...
              <li class="step">
                ...
                <div class="step-content">
                  <div class="card-type">
                    ...
                    <!-- <div class="mt-3 file-upload-button mx-auto">
                  ...
                  <div class="card-type">
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col col-md-4">
                          <input type="text" placeholder="Name" name="contact_name" id="contact_name" class="form-control" required  value="{{$ad_data->contact_name}}">
                          <span class="errorMessage"></span>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col col-md-4">
                          <input type="email" placeholder="Enter Email Address" name="contact_email" id="contact_email" class="form-control" required  value="{{$ad_data->contact_email}}">
                          <span class="errorMessage"></span>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col col-md-4">
                          <input type="text" placeholder="Enter Mobile Number" name="contact_number" id="contact_number" class="form-control" required  value="{{$ad_data->contact_number}}">
                          <span class="errorMessage"></span>
                        </div>
                      </div>
                    </div>
