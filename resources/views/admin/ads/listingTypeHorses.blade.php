  ...
  <div class="form-group">
    <div class="row">
      ...
      <div class="col col-md-4">
        <input type="text" placeholder="Name" class="form-control firstNoSpace" name="horse_name" id="horse_name" 
      ...
      <div class="col col-md-4">
        <input type="text" placeholder="Registration No." class="form-control firstNoSpace" name="horse_registration_no" id="horse_registration_no" value="{{ !empty($ad_data) ? $ad_data->horse_registration_no : ''}}" required>
        <span class="errorMessage"></span>
      </div>
    </div>
  </div>
...
<div class="card-type">
  ...
  <div class="form-group">
    <div class="row">
      ...
      <div class="col col-md-4">
        <select name="breed_primary" id="breed" class="form-control" required>
  ...
  <div class="form-group">
    <div class="row">
      <div class="col col-md-2 pr-0">
        <label for="" class="mb-0 mt-2 float-right">Gender<span class="text-orange">*</span></label>
      </div>
      <div class="col col-md-4">
