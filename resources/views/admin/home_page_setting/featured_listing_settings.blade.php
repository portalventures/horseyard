    ...
    <!-- Featured Listings -->
      <section>
        <div class="d-flex align-items-center justify-content-between">
          <h2 class="page-title">Featured listings slider</h2>
        ...
        <table class="table listing-table mt-4">
          ...
          <tbody id="feature-list">
            @foreach($featured_listings as $key => $ad)
              @php
              ...
              <tr>
                ...
                <td class="table-actions">
                  <div class="d-flex align-items-center justify-content-center">
                    <a class="remove-listing delete_featured_listing_blog" data-id="{{$ad->listing_master_id}}" data-object="featured">
          ...
          <tfoot>
            <tr>
              <td colspan="7" class="align-middle">             
                Showing {{ $featured_listings->firstItem() }} to {{ $featured_listings->lastItem() }} of total {{$featured_listings->total()}} items
              </td>
            </tr>
            <tr>
              <td colspan="8" class="single-item">
                @if($featured_listings->total() < 10)
                <a href="{{ url('admin/add-homepage-setting-listing')}}/{{'featured'}}" class="btn btn-primary">Add new item</a>
                @endif
              </td>
            </tr>
          </tfoot>
