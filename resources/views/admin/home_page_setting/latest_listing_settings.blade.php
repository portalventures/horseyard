  ...
  <div class="main-content">
    ...
    <section>
        <div class="d-flex align-items-center justify-content-between">
          <h2 class="page-title">Latest listings slider</h2>
        ...
        <table class="table listing-table mt-4">
          ...
          <tbody id="latest-list">
            @foreach($latest_listings as $key => $ad)
              @php
              ...
              <tr>
                ...
                <td class="table-actions">
                  <div class="d-flex align-items-center justify-content-center">
                    <a class="remove-listing delete_featured_listing_blog" data-id="{{$ad->listing_master_id}}" data-object="latest">
          ...
          <tfoot>
            <tr>
              <td colspan="7" class="align-middle">             
                Showing {{ $latest_listings->firstItem() }} to {{ $latest_listings->lastItem() }} of total {{$latest_listings->total()}} items
              </td>
            </tr>          
            <tr>
              <td colspan="8" class="single-item">
                @if($latest_listings->total() < 10)
                <a href="{{ url('admin/add-homepage-setting-listing')}}/{{'latest'}}" class="btn btn-primary">
                  Add new item
                </a>
                @endif
              </td>
