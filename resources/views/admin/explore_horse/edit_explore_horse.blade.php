    ...
    <section>
      ...
      <div class="card">
        <div class="card-content">
          ...
          <form action="{{ url('admin/update-explore-breed')}}" method="POST" enctype="multipart/form-data" class="blog_add_form">
            @csrf
            <input type="hidden" name="explore_horse_id" value="{{$explore_horse->id}}">
            <div class="form-group row align-items-start justify-content-between">
              ...
              <div class="col col-md-4 mr-auto">
                <select name="breed" id="breed" class="form-control">
                  <option value="{{$explore_horse->primary_breed_id}}" selected>{{dynamic_field_data($explore_horse->primary_breed_id)}}</option>
                ...
                <div class="row align-items-center">
                  <div class="col">                    
                    <label for="explore_horse_image" class="img_label">
                      ...
                      <img id="ad_image" src="{{ url('explore_by_horse')}}{{'/'}}{{$explore_horse->image}}" class="img-fluid">
                    </label>
